...
<![endif]-->
    ...
    <!-- Custom styles for unified login -->
    <style>
        .user-type-buttons {
            margin-bottom: 25px;
            text-align: center;
...
<body class="login-page">
    <div class="login-box">
        <div class="login-box-body">
            ...
            <!-- User Type Toggle Buttons (Admin, Manager, Employee) -->
            <div class="user-type-buttons">
                <div class="btn-group" role="group" aria-label="User Type">
                    <button type="button" class="btn btn-default" id="btn-admin" onclick="setUserType('admin')">
            ...
            <!-- Dynamic Title based on selected user type -->
            <h3 class="login-box-msg" id="login-title">Admin Sign In</h3>

            <!-- Unified Login Form with dynamic action -->
            <form action="{{ route('admin.login') }}" method="post" id="login-form">
                ...
                <div class="form-group has-feedback">
                    <input type="password" name="password" class="form-control sty1" placeholder="Password"
                        id="password-input" value="Admin1205">
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>

                <!-- Demo credentials hint -->
                <div class="demo-credentials text-center" id="demo-hint">
    ...
    <script type="text/javascript">
        function setUserType(type) {
            ...
            emailInput.placeholder = placeholders[type];
            ...
            demoHint.innerHTML = '<i class="fa fa-info-circle"></i> Demo: ' + demoEmails[type] + ' / Admin1205';

            // Optional: Auto-fill demo credentials (remove if you don't want this)
            emailInput.value = demoEmails[type];
            document.getElementById('password-input').value = 'Admin1205';
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const type = urlParams.get('type') || 'admin'; // Default to admin
            setUserType(type);

            // Add click event to buttons for better mobile support
